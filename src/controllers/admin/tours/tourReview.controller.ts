...
export const updateReview = async (req: Request, res: Response) => {
  try {
    const review = await tourReviewService.updateReview(req.params.id, req.body);
...
export const getAllReviews = async (req: Request, res: Response) => {
  try {
    ...
    const result = await tourReviewService.getAllReviews(searchParams, sortParams, paginateParams);
...
export const getReviewsByTourId = async (req: Request, res: Response) => {
  try {
    ...
    const result = await tourReviewService.getReviewsByTourId(
      req.params.tourId,
      sortParams,
      paginateParams,
    );
